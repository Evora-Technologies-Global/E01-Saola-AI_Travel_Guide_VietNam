...
```bash
python3 .claude/skills/ui-ux-pro-max/scripts/search.py "<app_type> mobile" --domain ux -n 5
python3 .claude/skills/ui-ux-pro-max/scripts/search.py "<app_type> card grid gallery" --domain style -n 3
```
