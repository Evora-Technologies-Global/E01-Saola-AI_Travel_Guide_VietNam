...
import com.evora.technologies.saola.data.remote.gemini.dto.GeminiErrorEnvelope
import com.evora.technologies.saola.data.remote.gemini.dto.GenerateContentRequest
import com.evora.technologies.saola.data.remote.gemini.dto.GenerateContentResponse
import com.evora.technologies.saola.data.remote.gemini.dto.GenerationConfig
...
internal class GeminiClient(
    ...
    suspend fun <T : Any> generateStructured(
        ...
        val request = GenerateContentRequest(
            ...
            generationConfig = GenerationConfig(
                ...
                thinkingConfig = thinkingLevel?.let { com.evora.technologies.saola.data.remote.gemini.dto.ThinkingConfig(it) },
            ),
        )
    ...
    suspend fun generateText(
        ...
        val request = GenerateContentRequest(
            ...
            generationConfig = GenerationConfig(
                temperature = temperature,
                thinkingConfig = com.evora.technologies.saola.data.remote.gemini.dto.ThinkingConfig(THINKING_LOW),
            ),
        )
