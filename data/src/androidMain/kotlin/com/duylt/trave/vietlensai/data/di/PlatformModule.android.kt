...
import com.duylt.trave.vietlensai.data.local.asset.AndroidBundledAssets
...
import com.duylt.trave.vietlensai.data.ocr.MlKitTextRecognizer
import com.duylt.trave.vietlensai.data.platform.FusedLocationRepository
...
internal actual val platformDataModule: Module = module {
    ...
    single<VietLensDatabase> {
        ...
        Room.databaseBuilder<VietLensDatabase>(
            context = context,
            name = context.getDatabasePath(VietLensDatabase.NAME).absolutePath,
        )
