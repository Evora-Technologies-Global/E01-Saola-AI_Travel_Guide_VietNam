...
val SaolaTypography = Typography(
...
object StampType {
     ...
     */
    val kicker: TextStyle = SaolaTypography.labelSmall.copy(
     ...
     * naming it.
     */
    val ordinal: TextStyle = SaolaTypography.labelMedium.copy(
        fontFamily = FontFamily.Monospace,
        fontWeight = FontWeight.Bold,
        lineHeight = 15.sp,
    )
    ...
    val caption: TextStyle = SaolaTypography.labelSmall.copy(
        fontFamily = FontFamily.Monospace,
    )
     ...
     */
    val seal: TextStyle = SaolaTypography.labelSmall.copy(
        fontSize = 7.sp,
        lineHeight = 9.sp,
        fontWeight = FontWeight.Bold,
...
/**
 * The five radii [SaolaShapes] is built from, as numbers rather than `Shape`s.
 *
 ...
 *
 * Not a slot in [SaolaShapes] because it is not a radius: it is a percentage, and it
