...
import com.evora.technologies.saola.navigation.SaolaRoot
 ...
 * answers with it.
 */
fun SaolaViewController(): UIViewController = SaolaRootViewController()

@OptIn(ExperimentalForeignApi::class)
private class SaolaRootViewController :
    ...
    private val composeController = ComposeUIViewController {
        ...
        SaolaTheme(themePreference = settings.darkTheme) {
